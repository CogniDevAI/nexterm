...
export const en = {
  ...
  "hostKey.keyTypeChangedWarning": "The host key for {host} has CHANGED and now uses a different algorithm. This can indicate a man-in-the-middle attack.",
  "hostKey.keyTypeChangedAdvice": "Do not accept unless you have verified the new fingerprint out-of-band with a trusted source. When in doubt, disconnect.",
  ...
  "monitoring.net.rx": "Net RX",
  "monitoring.net.tx": "Net TX",
  "monitoring.processes": "Processes",
  "monitoring.unsupported": "Monitoring is not available on this host (requires Linux /proc)",
  "monitoring.loading": "Starting monitor...",
  "monitoring.col.pid": "PID",
  "monitoring.col.user": "User",
  ...
  "tunnel.dynamicForward": "Dynamic Forward (-D / SOCKS5)",
  "tunnel.localShort": "Local Forward",
  "tunnel.remoteShort": "Remote Forward",
  "tunnel.dynamicShort": "SOCKS5 Proxy",
  "tunnel.start": "Start",
  "tunnel.stop": "Stop",
  ...
  "tunnelForm.listenDynamic": "Listen (SOCKS5 proxy)",
  ...
  "tunnelForm.descDynamic": "Start a local SOCKS5 proxy. Each connection is forwarded through the SSH session to its target host. Bind to 127.0.0.1 to restrict access to this machine.",
  ...
  "snippets.empty": "No snippets yet. Click Manage to add one.",
  "snippets.fillVariables": "Fill in variables",
  "snippets.preview": "Preview",
  "snippets.insert": "Insert",
  "snippets.execute": "Execute",
  "snippets.managerTitle": "Manage Snippets",
  "snippets.addSnippet": "Add Snippet",
  "snippets.editSnippet": "Edit Snippet",
  "snippets.name": "Name",
  "snippets.template": "Template",
  "snippets.folder": "Folder (optional)",
  "snippets.favorite": "Favorite",
  "snippets.save": "Save",
  "snippets.cancel": "Cancel",
  "snippets.delete": "Delete",
  "snippets.deleteConfirm": "Delete this snippet?",
  "snippets.namePlaceholder": "e.g. List files",
  "snippets.templatePlaceholder": "e.g. ls -la {{path:text:.}}",
